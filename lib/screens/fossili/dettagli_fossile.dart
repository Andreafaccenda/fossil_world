              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text('Latitudine: ${widget.model.latitudine.toString()}',style: const TextStyle(color: Colors.white,fontWeight: FontWeight.normal,letterSpacing: 0.5,wordSpacing: 1.5),),
                    const SizedBox(height: 5,),
                    Text('Latitudine: ${widget.model.longitudine.toString()}',style: const TextStyle(color: Colors.white,fontWeight: FontWeight.normal,letterSpacing: 0.5,wordSpacing: 1.5),),
                  ],
                ),
              ),
            ],),),
